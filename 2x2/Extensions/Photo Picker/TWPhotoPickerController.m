...
- (UIView *)topView {
    if (_topView == nil) {
        ...
        rect = CGRectMake(0, 0, 40, CGRectGetHeight(navView.bounds));
        UIButton *backBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        backBtn.frame = rect;
        [backBtn setImage:[UIImage imageNamed:@"photo_close_icon@2x"] forState:UIControlStateNormal];
        ...
        [cropBtn setTitle:@"خب" forState:UIControlStateNormal];
        [cropBtn.titleLabel setFont:[UIFont systemFontOfSize:18.0f]];

//
//  MyCompetitionsTableViewController.m
//  2x2
//
...
@interface MyCompetitionsTableViewController ()
...
@implementation MyCompetitionsTableViewController
{
...
- (void)viewDidLoad
{
    ...
    RequestCompleteBlock callback = ^(BOOL wasSuccessful,NSMutableDictionary *data) {
        if (wasSuccessful) {
            ...
            for (NSString *item in self.competitionDictionary)
            {
                ...
                competition.limit =[item valueForKey:@"type"];
    ...
    [self.getData GetStatusMyScoreDetail:st.accesstoken orgId:self.organizationID withCallback:callback];
